...
% Parameter TS
% if o2oOrderNum>0
%     MaxIterateTime = 1000 + round(5 * o2oOrderNum);
    MaxIterateTime=1200
...
if ecOrderNum==0
    ...
    InitialDistrTSPsolution=TaskDistribute(allVehicleTSPsolution,VehicleNum);
%     InitialDistrTSPsolution = GenerateSolusiRandom2 (Target_ecSite_id , part , kthcenter , partNum , VehicleNum);
end
...
siteFinalCost=siteFinalCost+LeastCost;              %该节点的该部分总代价
FinalPunishTime=FinalPunishTime+totalPunish;
FinalWaitTime=FinalWaitTime+totalWait;

costR(1,part)=LeastCost;
end
end
FinalCostTotal=FinalCostTotal + siteFinalCost;
