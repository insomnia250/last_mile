...
% Parameter TS
if merged_cost_record{MergedPair} <= cost_record{recordNum1} + cost_record{recordNum2}
    MaxIterateTime =1000 + o2oOrderNum*5 ;
    NeighbourSolutionNum = 200;
else
    MaxIterateTime =1 ;
...
%         [ecOrderNum , o2oOrderNum ,  iterateNum , LeastCost , FinalCostSite , FinalCostTotal , FinalPunishTime , FinalWaitTime]
        ...
        int2str(iterateNum) ,'         singleCost: ' , int2str(cost_record{recordNum1} + cost_record{recordNum2}) , ...  
