clear all;
tic;
load  'Site_id_record.mat' 'Site_id_record'
load  'TSP_record.mat' 'TSP_record'
recordNum=0;
...
% VehicleNum=round((ecOrderNum+3*o2oOrderNum)/19.04);
...
%     InitialDistrTSPsolutionWithO2O=RandomInsertO2OTask(InitialDistrTSPsolution,O2OshopVec,O2OspotVec);
% end
InitialDistrTSPsolutionWithO2O=TSP_record{recordNum};
%生成初始mutiVRP解
