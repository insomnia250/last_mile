...
points = {}
csvfile = open('../data/siteData.csv','rU')
...
csvfile.close()
csvfile = file('../data/spotData.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
	sInd,lng,lat = line
	if lng=='Lng':
	...
	points[sInd].extend([float(lng),float(lat)])
csvfile.close()
csvfile = file('../data/shopData.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
	sInd,lng,lat = line
	if lng=='Lng':
...
csvfile.close()
orders={}
csvfile = file('../data/ecOrderData.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
...
csvfile.close()
csvfile = file('../data/o2oOrderData.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
...
# ------------- loading solution ------------
solution = {}
csvfile = file('../Submission.csv','rU') # please input your solution path
lines = csv.reader(csvfile)
for line in lines:
